...
// --- M9.25 local-mode AdsDD* CRUD surface (M10.1 wiring) ------------------
//
// Real implementations live in src/abi/ace_exports.cpp where they
// can resolve the connection handle to its `engine::DataDict` and
// persist via the OpenADS-native text format. ace_stubs.cpp would
// duplicate them; the file intentionally has no DD CRUD body now.
